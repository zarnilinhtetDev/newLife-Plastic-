                    ...
                    <main>
                        <div class="container-fluid px-4 mt-4">
                            ...
                            <ol class="breadcrumb mb-4 ">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ url('/branch_list') }}">Branch List</a>
                                </li>
                                ...
                                <div class="row">
                                    <div class="col-md-6 offset-3">
                                        <div class="card  p-4">
                                            ...
                                            @endif
                                            <form action="{{ url('branch_update', $branchEdit->id) }}" method="POST">
                                                @csrf
                                                ...
                                                <button type="" class="btn btn-primary mt-3">Update</button>
                                        </div>
                                    </div>
